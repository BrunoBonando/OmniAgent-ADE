...
final class SessionHoverCardTests: XCTestCase {
    ...
    // MARK: - Diagnostic: NaN probe (temporary, see systematic-debugging)
    ...
    /// real thing does.
    private func assertNoNaNGeometry(_ view: NSView, _ path: String = "", file: StaticString = #filePath, line: UInt = #line) {
        let f = view.frame
