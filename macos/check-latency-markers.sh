...
rg -q 'name: "Latency.AppKitDisplayPassComplete"' "$native/TerminalSurfaceView.swift"

echo "latency marker chain: keyboard -> IPC -> PTY -> output -> feed -> AppKit display pass"
